...
const { getModuleId } = require("./utils/module.js");
...
function transformToCjs(entryDir, modulesMap) {
  for (const { ast, path: currentPath } of modulesMap.values()) {
    const exporters = {};
    ...
    traverse(ast, {
      ...
      // replace export default/named to const and push to __defineExports with last
